...
export function TaskErrorState({ onRetry }: TaskErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center rounded-xl border border-rose-200 bg-rose-50/30">
      ...
      <h3 className="text-base font-bold text-rose-950">Unable to load tasks</h3>
      <p className="text-xs text-rose-800/80 mt-1 max-w-sm">
        We couldn&apos;t load your task history. Please try again.
      </p>
      <Button
        variant="outline"
        size="sm"
