...
interface LeadProfileErrorProps {
  onRetry: () => void;
}

export function LeadProfileError({ onRetry }: LeadProfileErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center rounded-xl border border-rose-200 bg-rose-50/30">
      ...
      <h3 className="text-base font-bold text-rose-950">Unable to load lead</h3>
      <p className="text-xs text-rose-800/80 mt-1 max-w-sm">
        We couldn&apos;t load this lead&apos;s information. Please try again.
      </p>
      <Button
        variant="outline"
        size="sm"
