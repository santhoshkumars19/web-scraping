    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-5 mb-6">
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center gap-2.5">
          <Button variant="ghost" size="sm" asChild className="h-8 -ml-2 text-muted-foreground gap-1.5 hover:text-foreground">
            <Link href="/tasks">
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 px-2.5 py-0.5 rounded-md text-xs font-mono font-medium text-foreground">
            <span>{taskId}</span>
            <button
              onClick={copyTaskId}
